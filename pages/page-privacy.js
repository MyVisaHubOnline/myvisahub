                ...
                <div className="row">
                  ...
                  <div className="col-lg-8">
                    <div className="single-detail">
                      ...
                      />
                      <p className="mt-35">
                        At <strong>www.mypassporthub.com</strong>, we are
                        ...
                        services or visit our website. By accessing our website
                        or using our services, you consent to the practices
                        described in this policy.
                      </p>
                      <h6 className="mt-35 mb-25">1. Information We Collect</h6>
                      <p>
                        <strong>1.1 Personal Information</strong>
                      </p>
                      <p>
                        We may collect personal details necessary to process
                        your passport application or provide related services.
                      ...
                      <ul className="terms-of-service_ul-disc">
                        ...
                        <li>
                          <p>Travel itinerary and purpose of visit</p>
                        </li>
                      </ul>
                      <p className="mt-25">
                      ...
                      <ul className="terms-of-service_ul-disc">
                        <li>
                          <p>
                            To facilitate your passport application process,
                            including document preparation and submission.
                          </p>
                        </li>
                        <li>
                          <p>
                        ...
                        <li>
                          <p>
                            To enhance our website, services, and overall
                            customer experience.
                          </p>
                        </li>
                        <li>
                          <p>
                            To meet legal obligations or respond to lawful
                      ...
                      <ul className="terms-of-service_ul-disc">
                        ...
                        <li>
                          <p>
                            <strong>With your consent</strong>: If you
                      ...
                      <p>
                        We never sell, rent, or share your personal data for
                        marketing purposes.
                      </p>
                      <h6 className="mt-35 mb-25">4. Data Security</h6>
                      <p>
                        We take your data security seriously and implement
                        strong measures to protect it, including:
                      </p>
                      <ul className="terms-of-service_ul-disc">
                        <li>
                          <p>
                            <strong>Encryption</strong>: Sensitive information,
                            like payment details, is encrypted during
                            transmission.
                          </p>
                        </li>
                        <li>
                        ...
                        <li>
                          <p>
                            <strong>Secure storage</strong>: Data is stored on
                            secure servers with firewalls and continuous
                            monitoring.
                          </p>
                          <p>
                            While we take extensive precautions, no online
                            system is 100% secure. By using our services, you
                            acknowledge the inherent risks of online data
                            transmission.
                          </p>
                        </li>
                      </ul>
                      <h6 className="mt-35 mb-25">5. Data Retention</h6>
                      <p>
                      ...
                      <ul className="terms-of-service_ul-disc">
                        <li>
                          <p>Provide the requested services.</p>
                        </li>
                        <li>
                          <p>
                        ...
                        <li>
                          <p>Resolve disputes or enforce agreements.</p>
                          <p>
                            After this period, we securely delete or anonymize
                            your data.
                          </p>
                        </li>
                      </ul>
                      <h6 className="mt-35 mb-25">6. Your Rights</h6>
                      ...
                      <ul className="terms-of-service_ul-disc">
                        ...
                        <li>
                          <p>
                            <strong>Deletion</strong>: Ask for the deletion of
                        ...
                        <li>
                          <p>
                            ...
                            of your data for specific purposes.
                          </p>
                        </li>
                      </ul>
                      <p>
                        To exercise any of these rights, please contact us. We
                        may ask for proof of identity before processing your
                        request.
                      </p>
                      <h6 className="mt-35 mb-25">
                      ...
                      <p>
                        ...
                        experience. Cookies are small text files placed on your
                        device that help us:
                      </p>
                      <ul className="terms-of-service_ul-disc">
                        <li>
                          <p>Recognize repeat visitors</p>
                        </li>
                        <li>
                          <p>Track usage patterns</p>
                        </li>
                        <li>
                          <p>Offer personalized content or recommendations</p>
                        </li>
                      </ul>
                      <p>
                        You can manage or disable cookies through your browser
                        settings. However, disabling cookies may impact the
                        functionality of our website.
                      </p>
                      <h6 className="mt-35 mb-25">8. Third-Party Links</h6>
                      <p>
                        Our website may include links to other websites. Please
                        note:
                      </p>
                      <ul className="terms-of-service_ul-disc">
                        <li>
                      ...
                      <h6 className="mt-35 mb-25">9. Children’s Privacy</h6>
                      <p>
                      ...
                      <ul className="terms-of-service_ul-disc">
                        <li>
                          <p>
                            <strong>Contractual necessity</strong>: To fulfill
                            our agreement to provide services.
                          </p>
                        </li>
                        <li>
                          <p>
                        ...
                        <li>
                          <p>
                            ...
                            our services and website functionality.
                          </p>
                        </li>
                        <li>
                          <p>
                            <strong>Consent</strong>: In cases where explicit
                            consent is required, such as for marketing purposes.
                          </p>
                        </li>
                      </ul>
                      <p>
                      ...
                      <p>
                        ...
                        changes will be posted on this page, and the revised
                        date will be noted at the top. We encourage you to
                      ...
                      <p>
                        We are committed to addressing any privacy-related
                        issues transparently and promptly.
                      </p>
                      <p>
                        By using <strong>My Passport Hub</strong> services, you
